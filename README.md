...
- **CompassChromeApplicationCustomizer** — a site-wide extension that injects the header (with hover mega-menus and an AI assistant entry point) and footer into every page of the site.
- **api/** — an optional Azure Function backend that proxies chat messages to OpenAI, keeping the API key server-side.
